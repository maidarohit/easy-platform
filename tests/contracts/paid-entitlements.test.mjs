...
test("private beta access is server-only and limited to core testing categories", async () => {
  ...
  assert.match(contents, /PRIVATE_BETA_CATEGORIES = new Set<UsageCategory>\(\["projects", "standardAiTasks", "aiManagerRuns", "imageGenerations", "videoGenerations", "presentationGenerations"\]\)/);
