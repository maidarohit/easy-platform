...
const ACTION_BUTTON = "rounded-lg border border-slate-500 bg-slate-800 px-3 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:border-cyan-300 hover:bg-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:cursor-not-allowed disabled:border-slate-700 disabled:bg-slate-900 disabled:text-slate-500 disabled:shadow-none";
const SAVE_BUTTON = "self-end rounded-lg border border-cyan-300 bg-cyan-950 px-3 py-2 text-xs font-semibold text-cyan-50 shadow-sm transition-colors hover:border-cyan-200 hover:bg-cyan-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:cursor-not-allowed disabled:border-slate-700 disabled:bg-slate-900 disabled:text-slate-500 disabled:shadow-none";
const REMOVE_BUTTON = "rounded-lg border border-red-400 bg-red-950 px-3 py-2 text-xs font-semibold text-red-100 shadow-sm transition-colors hover:border-red-300 hover:bg-red-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:cursor-not-allowed disabled:border-slate-700 disabled:bg-slate-900 disabled:text-slate-500 disabled:shadow-none";
