...
const strategySections = brandResult
  ? [
      ...
      { key: "adCopy", label: "Ad Copy", value: brandResult.adCopy },
      ...
      { key: "funnelSuggestions", label: "Funnel Suggestions", value: brandResult.funnelSuggestions },
      { key: "kpis", label: "KPIs", value: brandResult.kpis },
      { key: "growthRecommendations", label: "Growth Recommendations", value: brandResult.growthRecommendations },
      { key: "marketingScore", label: "Marketing Score", value: brandResult.marketingScore },
      { key: "bestChannels", label: "Best Channels", value: brandResult.bestChannels },
      { key: "campaignTimeline", label: "Campaign Timeline", value: brandResult.campaignTimeline },
      { key: "customerJourney", label: "Customer Journey", value: brandResult.customerJourney },
      { key: "contentMix", label: "Content Mix", value: brandResult.contentMix },
