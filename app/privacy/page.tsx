...
export default function PrivacyPage() {
  return <LegalPage title="Privacy Policy" updated="17 August 2026">
    ...
    <section><h2>Contact</h2><p>Privacy requests may be sent through the <a className="underline" href="/contact-support">Contact and Support page</a>. Requests will be handled in accordance with applicable privacy requirements.</p></section>
  </LegalPage>;
}
