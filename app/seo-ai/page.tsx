        ...
        <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8 lg:px-10 lg:py-12">
          ...
          <section className="relative mt-10 overflow-hidden rounded-[28px] border border-red-500/20 bg-slate-950/70 p-5 shadow-[0_0_60px_rgba(239,68,68,0.07)] backdrop-blur-xl sm:p-8">
            ...
            <div className="mt-7 grid gap-6 md:grid-cols-2">
              ...
              <label className="block"><span className={labelClass}><span>Website / Content Style</span><span className={codeClass}>STRATEGY / 04</span></span><div className="relative"><select value={brandStyle} onChange={(e) => setBrandStyle(e.target.value)} className={selectClass}><option>Minimal</option><option>Modern</option><option>Corporate</option><option>Luxury</option><option>Creative</option><option>Dark</option><option>Light</option><option>Glassmorphism</option><option>Neumorphism</option><option>Futuristic</option></select><span className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-cyan-400">⌄</span></div></label>
