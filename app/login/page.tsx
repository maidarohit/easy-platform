...
export default function LoginPage() {
  ...
  const handleLogin = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const requestedReturn = safeLoginReturn(
      ...
      setErrorMessage(
        firebaseAuthErrorMessage(error, "Unable to sign in. Please try again."),
      );
  ...
  return (
    <main className="min-h-screen bg-[#F7F4EC] text-[#1B211E] lg:grid lg:grid-cols-[1.08fr_.92fr]">
      <section className="relative overflow-hidden border-b border-[#173D32]/10 bg-[#EEE9DC] px-5 py-8 sm:px-10 sm:py-12 lg:flex lg:min-h-screen lg:flex-col lg:justify-between lg:border-b-0 lg:border-r lg:px-14 lg:py-12 xl:px-20">
        ...
        <Link
          href="/"
          className="relative z-10 inline-flex w-fit items-center gap-2 rounded-lg text-sm font-semibold text-[#173D32] transition hover:text-[#0E2C24] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#173D32]"
        >
          <svg
            aria-hidden="true"
            viewBox="0 0 20 20"
        ...
        <div className="relative z-10 mt-12 max-w-2xl sm:mt-16 lg:my-auto lg:py-16">
          <p className="text-sm font-semibold tracking-[-0.02em] text-[#173D32]">
            Buzypeezy
          </p>
          ...
          <p className="mt-6 max-w-xl [font-size:clamp(1rem,1.4vw,1.1875rem)] leading-[1.75] text-[#6F756F]">
            Everything you’re building with Buzypeezy is waiting for you. Sign
            in and continue from where you left off.
          </p>
          ...
          <div className="mt-9 hidden space-y-3 sm:block lg:mt-12">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-3 text-base text-[#4F5B55]"
              >
                <span className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#173D32]/12 bg-[#FCFBF7]/65 text-[#173D32]">
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 20 20"
                    fill="none"
        ...
        <p className="relative z-10 mt-10 hidden text-xs uppercase tracking-[0.18em] text-[#8A918C] lg:block">
      ...
      <section className="flex items-center justify-center bg-[#F7F4EC] px-5 py-10 sm:px-10 sm:py-14 lg:min-h-screen lg:px-14">
        <div className="w-full max-w-lg">
          <div className="rounded-[28px] border border-[#173D32]/10 bg-[#FCFBF7] p-6 shadow-[0_24px_70px_rgba(40,52,45,0.08)] sm:p-10 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
            ...
            <h2 className="mt-4 [font-size:clamp(2.25rem,3.5vw,2.625rem)] font-semibold leading-tight tracking-[-0.045em] text-[#0E2C24]">
              Welcome back
            </h2>
            <p className="mt-3 [font-size:clamp(1rem,1.3vw,1.1875rem)] leading-7 text-[#6F756F]">
              Sign in to continue with Buzypeezy.
            </p>
            ...
            <form className="mt-9" onSubmit={handleLogin}>
              <div>
                <label
                  htmlFor="email"
                  className="mb-2.5 block text-[15px] font-semibold text-[#344039]"
                >
                  Email Address
                </label>
                <input
              ...
              <div className="mt-4 flex justify-end">
                <Link
                  ...
                  className="text-sm font-semibold text-[#173D32] underline decoration-[#B89A61]/60 underline-offset-4 transition hover:text-[#0E2C24]"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <p className="mt-7 text-center text-base text-[#6F756F]">
              ...
              <Link
                href="/signup"
                className="font-semibold text-[#173D32] underline decoration-[#B89A61]/60 underline-offset-4 transition hover:text-[#0E2C24] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#173D32]"
              >
                Start building →
              </Link>
            </p>
