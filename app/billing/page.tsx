  ...
  return (
    <main className="min-h-screen bg-[#F7F4EC] px-5 py-16 text-[#1B211E]">
      <div className="mx-auto max-w-4xl">
        <Link href="/" className="font-semibold text-[#173D32]">← Easy Platform</Link>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          ...
          <section className="rounded-2xl border border-[#173D32]/10 bg-white p-6"><h2 className="text-2xl font-semibold text-[#0E2C24]">Enterprise</h2><p className="mt-3 text-lg text-[#52605A]">Custom</p><a href="mailto:support@easyplatform.com?subject=Enterprise%20plan" className="mt-8 block w-full rounded-xl border border-[#173D32]/20 px-4 py-3 text-center font-semibold text-[#173D32]">Contact Sales</a></section>
        </div>
      </div>
    </main>
  );
