        ...
        {website && <section id="website" className="scroll-mt-6 py-14">
          ...
          <div className="mt-7 overflow-x-auto rounded-[28px] bg-[#D8DCCF]/55 p-3 sm:p-6">
            <div className={`mx-auto overflow-hidden rounded-[22px] bg-white shadow-xl transition-all ${VIEWPORT_WIDTH[viewport]}`}>
              ...
              {website.services && <div className="grid gap-5 px-6 py-10 sm:grid-cols-3 sm:px-10"><div className="sm:col-span-3"><p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#8A713F]">What we offer</p><OptionalText value={website.services} className="mt-3 whitespace-pre-wrap text-sm leading-7 text-[#606A64]" /></div></div>}
