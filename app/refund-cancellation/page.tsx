...
export default function RefundCancellationPage() {
  return <LegalPage title="Refund and Cancellation Policy" updated="17 August 2026">
    ...
    <section><h2>Refund requests</h2><p>Refund requests will be reviewed against applicable law and the circumstances of the transaction. Email <a className="underline" href="mailto:support@buzypeezy.ai">support@buzypeezy.ai</a> promptly with the transaction reference and reason for the request; never send full card details.</p></section>
    <section><h2>Request processing</h2><p>Additional information may be requested where reasonably necessary to review a cancellation or refund request. The outcome will be communicated through the official support email.</p></section>
  </LegalPage>;
}
