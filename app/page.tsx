...
export default function Home() {
  const outcomes = [
    ...
    ["Keep Growing", "Understand what is working and what Easy recommends next."],
  ];
  const steps = [
    ["Tell us about your business", "Write naturally. You don’t need to know technical terms."],
    ["Easy understands what you need", "Your goals, customers and direction are organised automatically."],
  ...
  const plans = [
    { name: "Starter", price: "£29", period: "/month", description: "A focused foundation for getting your business organised and moving.", features: ["One organised business workspace", "Core direction and presence", "Essential project capacity"] },
    { name: "Growth", price: "£79", period: "/month", description: "More room to build, reach customers and improve what is working.", features: ["Expanded project capacity", "Growth and content workflows", "Ongoing performance direction"], featured: true },
    { name: "Business", price: "Custom", period: "", description: "Flexible capacity for established teams with broader business needs.", features: ["Flexible business capacity", "Connected team workflows", "Priority business support"] },
  ];
    ...
    <main className="min-h-screen overflow-hidden bg-[#F7F4EC] text-[#1B211E] selection:bg-[#A8B8A7]/50">
      <nav className="sticky top-0 z-50 border-b border-[#173D32]/10 bg-[#F7F4EC]/90 backdrop-blur-xl" aria-label="Primary navigation">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8">
          <Link href="/" className="text-2xl font-semibold tracking-[-0.03em] text-[#0E2C24] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#173D32]">Easy Platform</Link>
      ...
      <section className="relative border-b border-[#173D32]/10 py-20 sm:py-28 lg:py-32">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:gap-20">
          <div>
            ...
            <p className="mt-8 max-w-2xl [font-size:clamp(1.0625rem,1.7vw,1.375rem)] leading-[1.65] text-[#626A64]">Tell Easy what you do and where you want to go. We’ll turn it into a complete digital business system — ready to build, grow and improve.</p>
          ...
          <div className="relative rounded-[32px] border border-[#173D32]/15 bg-[#FCFBF7] p-6 shadow-[0_30px_80px_rgba(40,52,45,0.10)] sm:p-8">
            ...
            <p className="mt-6 text-center text-sm font-medium text-[#52605A]">Easy is taking care of it.</p>
          </div>
        </div>
      </section>
