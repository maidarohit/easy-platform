...
export default function Home() {
  ...
  const plans = [
    { name: "Pro", price: "₹1,999", period: "/month", description: "The complete Easy workspace for growing your business.", features: ["Connected business workspace", "AI business tools", "Saved projects and outputs"] },
